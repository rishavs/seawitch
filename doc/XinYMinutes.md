...
Tree - TODO
```
myArray = Array<Int>.new(1, 2, 3)
myArrayWithLiterals : Array<Int> = [3, 4]

myFixedArray = Array<String, Int>.new("one", 1)

myAdder = (x: Int, y:Int) -> Int {
    return x + y
}
someVar = myAdder 1, 2

myNewAdder : Fun (Int, Int) -> Int = (x, y) -> {
    return x + y
}
someOtherVar = myNewAdder(3,4)
